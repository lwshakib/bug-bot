...
- **CRITICAL & ARCHITECTURAL BREAKING ISSUES**: If you detect a critical vulnerability, structural flaw, or an issue that could break the system architecture:
  ...
  4. Prepend the issue title with \`[BREAKING]\` or \`[ARCHITECTURAL]\` and include a bold warning at the top of the body: \`**⚠️ DO NOT AUTO-FIX: This issue requires human intervention, architectural context, and manual resolution. Automated PR agents must skip this issue.**\`
  These issues require human intervention and must NOT be auto-fixed by PR agents.
